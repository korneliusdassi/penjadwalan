...
if(isset($_POST["addjadwal"])){
  $hari= mysqli_real_escape_string($kon ,$_POST["hari"]);
  $nama=mysqli_real_escape_string($kon ,$_POST["namasiswa"]);
  $pel=mysqli_real_escape_string($kon ,$_POST["namapel"]);
  $kls=mysqli_real_escape_string($kon ,$_POST["kelas"]);
  $guru=mysqli_real_escape_string($kon ,$_POST["guru"]);

  $query="INSERT INTO jadwal VALUES ('','$hari','$nama', '$pel', '$kls', '$guru')";
      ...
      <div class="container-fluid">
          ...
          <div class="card-body">
            <form method="POST">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <option value="">-Pilih-</option>
                      <?php                 
                        $data = mysqli_query($kon,"SELECT * FROM mapel");
                        while($rows= mysqli_fetch_array($data)):
                            $rows["nama_mapel"];
                            $rows["id_mapel"];  
                        ?>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <option value="">-Pilih-</option>
                      <?php                 
                        $data = mysqli_query($kon,"SELECT * FROM kelas");
                        while($rows= mysqli_fetch_array($data)):
                            $rows["nama_kelas"];
                            $rows["id_kelas"];  
                        ?>
                  ...
                  <div class="form-group">
                    ...
                    <option value="">-Pilih-</option>
                      <?php                 
                        $data = mysqli_query($kon,"SELECT * FROM guru");
                        while($rows= mysqli_fetch_array($data)):
                            $rows["nama_guru"];
                            $rows["id_guru"];  
                        ?>
              ...
              <div>
                <button type="submit" name="addjadwal" class="btn btn-block btn-success">Tambah</button>
              </div>
            </form>
          </div>
      </div>
